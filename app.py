...
def calculate():
 ...
 #print the risk of CKD stage ≥3
    ...
    st.image('CKD3.png')
    st.caption('Likelihood of CKD stage ≥3 based on PURK Score - a combined cohort of SickKids (Toronto, Canada), IWK (Halifax, Canada), CHOC (Orange County, US), Monash Children (Melbourne, Australia), and Sanjay Gandhi Hospital (Lucknow, India)')
